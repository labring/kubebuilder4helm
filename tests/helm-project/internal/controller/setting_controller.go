...
const settingFinalizer = "user.my.domain/finalizer"
...
type SettingReconciler struct {
	...
	// For more details
	// - https://github.com/labring/operator-sdk/blob/v1.0.1/controller/finalizer.go
	finalizer *controller.Finalizer
}

//+kubebuilder:rbac:groups=user.my.domain,resources=settings,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=user.my.domain,resources=settings/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=user.my.domain,resources=settings/finalizers,verbs=update
//+kubebuilder:rbac:groups=core,resources=events,verbs=create;patch

// finalizeSetting will perform the required operations before delete the CR.
func (r *SettingReconciler) doFinalizerOperationsForSetting(ctx context.Context, setting *userv1beta1.Setting) error {
...
func (r *SettingReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if ok, err := r.finalizer.RemoveFinalizer(ctx, setting, func(ctx context.Context, obj client.Object) error {
		ctxObject := obj.(*userv1beta1.Setting)
...
func (r *SettingReconciler) reconcile(ctx context.Context, obj client.Object) (ctrl.Result, error) {
	...
	setting, ok := obj.(*userv1beta1.Setting)
	var err error
	if !ok {
...
func (r *SettingReconciler) SetupWithManager(mgr ctrl.Manager, opts controller.RateLimiterOptions) error {
	if r.finalizer == nil {
