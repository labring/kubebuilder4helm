...
func main() {
	...
	showVersion := false
	cmd := &cobra.Command{
		Use:   "controller-gen4helm",
		Short: "Generate Kubernetes API extension resources and code.",
		Long:  "Generate Kubernetes API extension resources and code.",
		Example: `	# Generate RBAC manifests and webhook for all types under apis/,
	# outputting crds to /tmp/crds and everything else to stdout
	controller-gen4helm rbac:roleName=<role name> webhook paths=./apis/... output:stdout
`,
